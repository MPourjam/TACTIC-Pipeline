...
def main_processing(input_dir, paired, forward_file, reverse_file, input_id, spike_amount=0):
    try:
        ...
        if reverse_file:
            ...
            print('Merging Pairs DONE')
            trim_sides()
            print('Trim Sides DONE')
            filter_merged_reads()
            print('Filter merged DONE')
        else:
