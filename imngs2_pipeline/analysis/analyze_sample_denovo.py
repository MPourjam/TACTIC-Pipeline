...
def main(user_name, analysis_q_id):
    ...
    print('Sorting Done')
    clusterZOTUs()
    print('Cluster ZOTUs DONE')
    filter16S()
    print('Filtering our non 16S ZOTUs')
    prepare_zotus()
    print('Prepared Zotus Done')
    clusterOTUs()
    print('Cluster OTUs Done')
    remove_size_from_OTUS()
    print('Removed sizes from OTUs')
    assign_zotus_to_otus()
    print('Assigned ZOTUs to OTUs')
    keep_good_ZOTUs()
    print('Kept non-chimeras ZOTUs')
    build_ZOTU_table()
    print('Build ZOTU table')
    filter_zotu_abundance(analysis_obj.abundance)
    print('ZOTUs Abundance Filtered')
    select_zotu_seqs()
    print('Select ZOTUs Filtered')
    addTax()
    create_final_ZOTU_table()
    print('ZOTUs Table Created')
    add_taxonomy_to_fasta()
    print('Taxonomy Added')
    create_OTUs_from_ZOTUS_table()
    print('Clean OTUS Created')
